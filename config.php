...
$config['database']['database'] = 'MYBB_DBNAME';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'MYBB_DBHOSTNAME:MYBB_DBPORT';
$config['database']['username'] = 'MYBB_DBUSERNAME';
$config['database']['password'] = 'MYBB_DBPASSWORD';
